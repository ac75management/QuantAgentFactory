...
formato y corta fechas, no evalua calidad ni rellena huecos.
...
def process_file(raw_path, manifest_entries):
    ...
    print(
        f"OK   {symbol} [{tf}]: {n_after} barras limpias ({dropped} duplicadas/invalidas descartadas) "
    ...
    manifest_entries.append({
        ...
        "rows_raw": n_before,
        "rows_clean": n_after,
        "rows_dropped_duplicates_or_invalid": dropped,
        "rows_is": len(is_df),
        "rows_oos": len(oos_df),
