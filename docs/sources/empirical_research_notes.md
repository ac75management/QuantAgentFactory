...
- **Regla de data split "diseño en muestra PEQUEÑA (1-2 años), validar en muestra GRANDE OOS (10-14 años)"**, +6.71% de éxito reportado en cuenta real. → **Contradice nuestro 70/30 actual** (diseñamos en la porción grande, validamos en la chica). Es el conflicto más importante sin resolver — ver [docs/review_round3.md](../review_round3.md), no se resolvió por cuenta propia.
