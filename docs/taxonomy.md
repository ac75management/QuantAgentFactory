...
Filtro de madurez para lo que `investigator` acepta como fuente. Adaptado del material que trajo Alexander (septiembre de 2026).
...
6. **Élite / creador de mercado** — sistemas dinámicos complejos, teoría del caos, aprendizaje por refuerzo multiagente. Aspiracional, no operable con nuestros recursos hoy — ver la nota de escepticismo en [docs/archive/reviews/review_round3.md](archive/reviews/review_round3.md).
